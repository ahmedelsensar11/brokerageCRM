    ...
    <div class="mt-3">
        <div class="row">
            ...
            <div class="col-lg-6  d-flex flex-column justify-content-center align-items-center text-bold text-danger p-3">
                <p>There are no customers for you now !!</p> <p>maybe later the manager will add customers</p>
            </div>
        </div>
    </div>
        ...
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <!--action button-->
              <td><a class="btn btn-primary" href="{{url('/employee/addAction/'.$customer->id)}}" role="button"><i class="fas fa-user-edit"></i> Action</a></td> 
